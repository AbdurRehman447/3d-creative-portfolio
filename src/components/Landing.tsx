...
const Landing = ({ children }: PropsWithChildren) => {
  ...
  const name = useTypingEffect("ABDUR REHMAN", 1500, 120, !isLoading);
      ...
      <div className="landing-section" id="landingDiv">
        ...
        <div className="landing-container">
          <div className="landing-intro">
            <h2>Hello! I'm</h2>
            <h1 className="landing-typed-name" aria-label="ABDUR REHMAN">
          ...
          <div className="landing-info">
            <h3>Full Stack</h3>
            <h2 className="landing-info-h2" aria-label="Developer, Engineer">
