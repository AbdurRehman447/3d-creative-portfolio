  ...
  return (
    <div className="icons-section">
      <div className="social-icons" data-cursor="icons" id="social">
        <span>
          <a href="https://github.com/AbdurRehman447" target="_blank" rel="noreferrer">
            <FaGithub />
          </a>
        </span>
        <span>
          <a href="https://www.linkedin.com/in/mani-baig/" target="_blank" rel="noreferrer">
            <FaLinkedinIn />
          </a>
        </span>
        <span>
          <a href="https://www.facebook.com/profile.php?id=100091908776684" target="_blank" rel="noreferrer">
            <FaFacebookF />
          </a>
        </span>
      </div>
